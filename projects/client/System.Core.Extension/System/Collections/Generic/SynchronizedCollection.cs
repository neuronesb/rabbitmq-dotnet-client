...
namespace System.Collections.Generic
{
    ...
    public class SynchronizedCollection<T> : IList<T>, IList
    {
            ...
            set
            {
                lock (this.sync)
                {
                    if (index < 0 || index >= this.items.Count)
                        throw new ArgumentOutOfRangeException("index", index, string.Format( "ValueMustBeInRange {0} - {1}", 0, this.items.Count - 1));
        ...
        public void Insert(int index, T item)
        {
            ...
            {
                if (index < 0 || index > this.items.Count)
                    throw new ArgumentOutOfRangeException("index", index, string.Format("ValueMustBeInRange {0} - {1}", 0, this.items.Count));
        ...
        static void VerifyValueType(object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("SynchronizedCollectionWrongType1 {0}", value.GetType().FullName));
            }
        }
    }
}
