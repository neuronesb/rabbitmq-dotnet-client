...
namespace System.Runtime.Serialization
{
    ...
    public sealed class SerializationInfo
    {
...
#endif
        {
            ...
            m_assemName = type.GetTypeInfo().Module.Assembly.FullName;
        ...
        **Exceptions: None.  All error checking is done with asserts.
        ...
        private int FindElement(String name)
        {
            ...
            Contract.EndContractBlock();
            Debug.WriteLine("SER", "[SerializationInfo.FindElement]Looking for ", name, " CurrMember is: ", m_currMember);
            int index;
        ...
        **            found.
        ...
        private Object GetElement(String name, out Type foundType)
        {
            ...
            if (index == -1)
            {
                throw new SerializationException("Serialization_NotFound " + name);
            }
